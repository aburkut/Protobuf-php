 ...
 *
 * Generated from protobuf message <code>msg_1.ErrorResponse</code>
 */
class ErrorResponse extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.msg_1.ErrorCode code = 1;</code>
     */
    private $code = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Msg_1\ErrorCode::class);
        $this->code = $var;
